    ...
    return (
        <Formik
            ...
            onSubmit={async (values, actions) => {
                ...
                setLoading(true)
                const response: TResponseLoginUser = await createUserSession(
                    userData
                )
                ...
                if (response.statusCode === HTTP_CODE.OK) {
                    ...
                    const userBasicData: TUserBasicResponseData =
                        await getUserData(response.userId)
                    ...
                    setLoading(false)
                    const message: string = getValidationLoginMessage(
                        response.statusCode
                    )
